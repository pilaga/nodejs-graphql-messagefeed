...
class Feed extends Component {
  ...
  finishEditHandler = postData => {
    ...
    //upload image first and get imagePath back
    ...
    .then(res => res.json())
    .then(fileResData => {
        const imageUrl = fileResData.filePath || "undefined"; //could be undefined, if not imge selected
        //send the graphql query to create post
        let graphqlQuery = {
          query: `
